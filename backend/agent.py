...
class ResumeAnalysisAgent:
    ...
    async def analyze(self, resume_text: str, jd_text: str, context: dict) -> AnalysisResponse:
...
"""
        ...
        try:
            ...
            return AnalysisResponse(
                ...
                weak_evidence=[],
                improvement_plan=[],
                final_summary="The analysis could not be completed due to a processing error. Please try again."
            )
